...
### 개요
* JT친애저축은행 홈페이지 , 관리자페이지 개발 및 유지보수

### 공헌한 내용
* 홈페이지 유지보수
* 관리자 공지사항 업로드 및 레이어팝업 업로드 개발
...
### 스택
* Git, HTML, CSS, BootStrap, JavaScript, jQuery, SpringBoot, Thymeleaf, Mysql(MyBatis)
<br>
<hr>
